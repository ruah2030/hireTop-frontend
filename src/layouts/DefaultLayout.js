            ...
            >
                <Flex
                    ...
                    <Flex flex={{ base: 1 }} justify={{ base: 'center', md: 'start' }}>
                        ...
                        <Flex display={{ base: 'none', md: 'flex' }} ml={10} justifyContent={'start'}>
                            <DesktopNav />
                        </Flex>
                    </Flex>
                    ...
                    <Stack
                        ...
                        {user.token == null ? (<>
                            ...
                            <ChakraLink as={ReactRouterLink} to={'/login'} style={{ textDecoration: 'none' }} display={'flex'} alignItems={'center'}>
                                <Button as={'a'} fontSize={'sm'} fontWeight={400} variant={'link'} href={'#'}>
                                    Se Connecter
                                </Button>
                            </ChakraLink>
                            <ChakraLink as={ReactRouterLink} to={'/register'} style={{ textDecoration: 'none' }}>
                                <Button
                                    as={'a'}
                        ...
                        </>) : <ChakraLink as={ReactRouterLink} to={'/admin'} style={{ textDecoration: 'none' }}>
            ...
            {NAV_ITEMS.map((navItem) => (
                <Box key={navItem.label}>
                    <Popover trigger={'hover'} placement={'bottom-start'}>
                        <PopoverTrigger>
                            <ChakraLink as={ReactRouterLink} to={navItem.href} style={{ textDecoration: 'none' }}>
                                <Box
                                    as="a"
                                    p={2}
                                    // href={navItem.href ?? '#'}
            ...
            <Container as={Stack} maxW={'6xl'} py={10}>
                <SimpleGrid
                    ...
                    <Stack spacing={6}>
                        ...
                        <Text fontSize={'sm'}>© 2022 Tout droit reservé</Text>
